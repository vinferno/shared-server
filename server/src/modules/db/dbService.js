...
var property_manager_model_1 = require("../models/property_manager.model");
var role_type_model_1 = require("../models/role_type.model");
var sub_account_model_1 = require("../models/sub_account.model");
var user_model_1 = require("../models/user.model");
// Associations
// User
user_model_1.User.hasOne(profile_model_1.Profile);
user_model_1.User.hasOne(account_model_1.Account);
user_model_1.User.belongsTo(role_type_model_1.RoleType);
// Profile
profile_model_1.Profile.belongsTo(user_model_1.User);
// Property
property_model_1.Property.belongsTo(account_model_1.Account);
// Account
account_model_1.Account.hasOne(user_model_1.User);
account_model_1.Account.hasMany(sub_account_model_1.SubAccount);
account_model_1.Account.hasMany(property_model_1.Property);
//PropertyManager
property_manager_model_1.PropertyManager.hasMany(property_model_1.Property);
